...
class BudgetAllocationGUI:
    ...
    def __init__(self, root):
        ...
        self.projects = []
        self.solution = None
        self.emergency_mode = tk.BooleanVar()
        self.emergency_type = tk.StringVar(value="Typhoon")
    ...
    def setup_gui(self):
        ...
        self.root.title("Barangay Budget Allocation System - Enhanced")
    ...
    def create_main_tab(self):
        ...
        """for col in ('Name', 'Cost', 'Benefit', 'Ratio', 'Category', 'Priority'):
            self.projects_tree.heading(col, anchor='center')"""
        ...
        """for col in ('Name', 'Cost', 'Benefit', 'Category', 'Priority'):
            self.solution_tree.heading(col, anchor='center')"""
